...
const translations = {
  ro: {
    ...
    "products.deluxePotato.title": "Cartof Copt cu Pui, Brânză, Valeriană și Smântână",
    "products.deluxePotato.description": "Cartof local 300g, pui 70g, sos de smântână 50g (smântână, lapte, făină albă, unt, piper alb, nucșoară), brânză 50g, valeriană, ulei de măsline extra virgin, sare de mare, piper negru măcinat. Alergeni: lapte, gluten, nucșoară.",
    ...
    "contact.address": "Splaiul Independenței 2K\nBucurești 030099",
  ...
  en: {
    ...
    "products.deluxePotato.title": "Baked Potato with Chicken, Cheese, Valerian and Sour Cream",
    "products.deluxePotato.description": "Local potato 300g, chicken 70g, cream sauce 50g (sour cream, milk, white flour, butter, white pepper, nutmeg), cheese 50g, valerian, extra virgin olive oil, sea salt, ground black pepper. Allergens: milk, gluten, nutmeg.",
